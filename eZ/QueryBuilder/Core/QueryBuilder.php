<?php
namespace eZ\Publish\QueryBuilder\Core;

use Exception;
use eZ\Publish\QueryBuilder\API\QueryBuilder as QueryBuilderInterface;
use eZ\Publish\QueryBuilder\Core\QueryBuilder\BaseQueryBuilder;
use eZ\Publish\API\Repository\Values\Content\Query\Criterion;

/**
 * @method \eZ\Publish\QueryBuilder\GeneratedQueryBuilder or(\eZ\Publish\QueryBuilder\API\QueryBuilder\Builder\CriterionBuilder $criterionBuilder) Start a LogicalOr criterion.
 * @method \eZ\Publish\QueryBuilder\GeneratedQueryBuilder and(\eZ\Publish\QueryBuilder\API\QueryBuilder\Builder\CriterionBuilder $criterionBuilder) Start a LogicalAnd criterion.
 */
